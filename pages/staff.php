            ...
            <div class="modal-body" style="padding-bottom: 0;">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="form-line" id="patient-email-error-line">
                                <input type="email" class="form-control details "
                                       id="edit-patient-email"
                                       name="edit-patient-email" placeholder="Email" oninput="patientEmailVerify(this.value)">
                            </div>
                            <label id="patient-email-error" style="display: none;" class="error error-msg" for="edit-patient-email">Email Already Exists!</label>
                        </div>
                    </div>
